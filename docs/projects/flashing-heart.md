...
![An animation that shows how to drag a block and paint a heart](/docs/static/mb/projects/flashing-heart/showleds.gif)
...
![Heart shape in the LEDs](/docs/static/mb/projects/flashing-heart/show-leds.gif)
